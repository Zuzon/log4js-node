...
class Configuration {
  ...
  tryLoading(modulePath) {
    ...
    try {
      switch(modulePath) {
        case 'categoryFilter': return require('./appenders/categoryFilter');
        case 'console': return require('./appenders/console');
        case 'dateFile': return require('./appenders/dateFile');
        case 'file': return require('./appenders/file');
        case 'fileSync': return require('./appenders/fileSync');
        case 'gelf': return require('./appenders/gelf');
      }
