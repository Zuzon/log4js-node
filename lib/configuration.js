...
class Configuration {
  ...
  tryLoading(modulePath) {
    ...
    try {
      switch(modulePath) {
        case 'categoryFilter': return require('categoryFilter');
        case 'console': return require('console');
        case 'dateFile': return require('dateFile');
        case 'file': return require('file');
        case 'fileSync': return require('fileSync');
        case 'gelf': return require('gelf');
      }
